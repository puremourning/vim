 ...
 *
 * The 'reason' parameter is passed to the custom debug func to explain _why_ we
 * stopped. This is particularly relevant when we break on returning from a
 * function due to a throw/error, and when we hit a catch/endif etc.
 */
    void
