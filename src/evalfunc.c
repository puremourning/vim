...
static void f_hint_start(typval_T *argvars UNUSED, typval_T *rettv UNUSED);
static void f_hint_set(typval_T *argvars UNUSED, typval_T *rettv UNUSED);
...
static void f_hint_set(typval_T *argvars, typval_T *rettv UNUSED)
{
    ...
    ins_hint_set_hints(argvars[0].vval.v_list);
}
